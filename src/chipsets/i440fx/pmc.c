...
void i440fx_pmc_smram_close() {
    pci_cfg_write_byte(I440FX_PMC_BUS, I440FX_PMC_SLOT, I440FX_PMC_FUNCTION, I440FX_PMC_SMRAM, I440FX_PMC_SMRAM_CLOSE | I440FX_PMC_SMRAM_EN | I440FX_PMC_SMRAM_DEFBASE);
}

void i440fx_pmc_smram_lock() {
    pci_cfg_write_byte(I440FX_PMC_BUS, I440FX_PMC_SLOT, I440FX_PMC_FUNCTION, I440FX_PMC_SMRAM, I440FX_PMC_SMRAM_CLOSE | I440FX_PMC_SMRAM_LOCK | I440FX_PMC_SMRAM_EN | I440FX_PMC_SMRAM_DEFBASE);
}
