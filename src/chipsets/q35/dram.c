...
void q35_dram_smram_close() {
    pci_cfg_write_byte(Q35_DRAM_BUS, Q35_DRAM_SLOT, Q35_DRAM_FUNCTION, Q35_DRAM_SMRAM, Q35_DRAM_SMRAM_EN);
}

void q35_dram_smram_lock() {
    pci_cfg_write_byte(Q35_DRAM_BUS, Q35_DRAM_SLOT, Q35_DRAM_FUNCTION, Q35_DRAM_SMRAM, Q35_DRAM_SMRAM_EN | Q35_DRAM_SMRAM_LOCK);
}
