...
static const uint8_t mode_80x25x16_text_crtc[][2] = {
    ...
    {VGA_CRTC_START_ADDR_HI, 0x00},
    {VGA_CRTC_START_ADDR_LO, 0x00},
    {VGA_CRTC_CURSOR_LOC_HI, 0x00},
    {VGA_CRTC_CURSOR_LOC_LO, 0x00},
...
static const uint8_t mode_320x200x256_linear_crtc[][2] = {
    ...
    {VGA_CRTC_PRESET_ROW_SCAN, 0x00},
    {VGA_CRTC_MAXIMUM_SCAN_LINE, 0x4f},
    {VGA_CRTC_CURSOR_START, 0x00},
    {VGA_CRTC_CURSOR_END, 0x00},
    {VGA_CRTC_START_ADDR_HI, 0x00},
    {VGA_CRTC_START_ADDR_LO, 0x00},
    {VGA_CRTC_CURSOR_LOC_HI, 0x00},
    {VGA_CRTC_CURSOR_LOC_LO, 0x00},
